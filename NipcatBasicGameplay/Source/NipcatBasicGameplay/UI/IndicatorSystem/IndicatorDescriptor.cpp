...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UNipcatIndicatorManagerComponent* InManager)
{
...
{
	if (UNipcatIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
